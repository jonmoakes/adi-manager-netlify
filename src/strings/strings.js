...
export const editPupilProgressEntryPath = "/edit-pupil-progress";
...
export const latestLessonPerformance = "latest lesson progress";
export const makingProgress = "making progress";
export const meetingTraffic = "meeting traffic";
export const miniRoundabouts = "mini roundabouts";
export const motorways = "motorways";
export const movingOffandStopping = "M/Off & Stopping";
export const oneWayStreets = "one way streets";
export const parallelPark = "parallel park";
export const pedestrianCrossings = "pedestrian crossings";
export const pullUpRight = "pull up on the right";
export const reverseBayPark = "reverse bay park";
export const roundabouts = "roundabouts";
export const satNav = "sat-nav";
export const turnInTheRoad = "turn in the road";
export const trafficLights = "traffic lights";
export const turningLeft = "junctions - turn left";
export const turningRight = "junctions - turn right";
